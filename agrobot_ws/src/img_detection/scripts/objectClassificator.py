...
import sys
sys.path.append("/home/S8/agrobot/src/imgDetection/scripts")
...
if __name__ == '__main__':
    ...
    model = rospy.get_param("model/path", default = "/home/al3x/S8/agrobot_ws/src/img_detection/scripts/plantas.onnx")
