...
class ModelPredict:
    ...
    def start_detection(self) -> None:
        ...
        square_turtle.shapesize(20)
        cap = cv.VideoCapture(2) # Open the camera
        while cap.isOpened():
                ...
                for object in self.__class_list:
                    ...
                    if class_ids:
                        ...
                        if(object == 'MA'):
                            ...
                            square_turtle.write("FAIL!", align="center", font=("Arial", 20, "bold"))
                            MA +=1
                        elif(object == 'MD'):
                            square_turtle.color("red")
                            square_turtle.shape("square")
                            square_turtle.pencolor("black")
                            square_turtle.write("FAIL!", align="center", font=("Arial", 20, "normal"))
                            MD += 1
                        elif(object == 'BA'):
                            square_turtle.color("green")
                            square_turtle.shape("square")
                            square_turtle.pencolor("black")
                            square_turtle.write("PASS!", align="center", font=("Arial", 20, "normal"))
                            BA += 1
                        elif(object == 'BD'):
                            square_turtle.color("green")
                            square_turtle.shape("square")
